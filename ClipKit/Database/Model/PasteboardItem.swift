...
public extension PasteboardItem
{
    ...
    class func historyFetchRequest(limit: Int) -> NSFetchRequest<PasteboardItem>
    {
        ...
        fetchRequest.fetchBatchSize = limit > 0 ? min(limit, 50) : 50
        return fetchRequest
    }

    class func historyFetchRequest() -> NSFetchRequest<PasteboardItem>
    {
        return historyFetchRequest(limit: UserDefaults.shared.historyLimit.rawValue)
    }
}
